...
if __name__ == "__main__":
    scraper = WesternUnionScraperGT()
    result = scraper.get_estimate("US", "GT", 500)
    print("\n" + "="*60)
    print("WESTERN UNION - USA -> GUATEMALA")
    print("="*60)
